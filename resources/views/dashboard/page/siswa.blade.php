...
<div class="container-fluid">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table-action">
                            ...
                            <a href="/admin/dashboard/siswa/edit/{{$item->id}}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
    ...
    <script>
        function showDeleteModal(siswaId) {
            ...
            deleteForm.action = '/admin/dashboard/siswa/delete/' + siswaId;
